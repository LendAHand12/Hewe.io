...
export const MultipleButton = styled.button`
        ...
        background: ${({ selected }) => (selected ? 'transparent linear-gradient(90deg, #E42279 0%, #6C1D63 100%) 0% 0% no-repeat padding-box' : '#FFF9FB')};
        color: ${({ selected }) => (selected ? '#FFF9FB' : '#650E6D')};
