...
import { Column1, Column2, ImgWrap, InfoContainer, InfoRow, InfoWrapper, InputBox, LoginBox, LoginButton, LoginHeading, LoginPara, TextWrapper } from './LoginElements';
...
const InfoSection = ({ lightBg, imgStart, img, pageHeading, pagePara, form, history, setUsers, userData, defaultState, setDefaultState, }) => {
    ...
    const sendOTP = async (values, forget = false) => {
        ...
        try {
            ...
            history.push('/supermarket/forgototp')
            setOtpSend(true);
            //   setDefaultState({
            //     isSignup: true,
            //     isLogin: false,
                                                ...
                                                <Form className={classes.formStyleOnly}>
                                                    ...
                                                    <div className="text-center login_btn_group">
                                                        <LoginButton
                                                            ...
                                                            type="submit"
                                                        >
                                                         <Link to="//resetpassword">Send Link</Link>
  
                                                        </LoginButton>
                                                    </div>
                                                    <p className="text-center" style={{ fontSize: "10px", padding: "0.3rem" }}>
                                                        <Link
                                                            style={{
                                                                fontSize: "20px",
                                                                color: "#540174"
