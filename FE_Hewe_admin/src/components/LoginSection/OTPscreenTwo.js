...
const InfoSection = ({ lightBg, imgStart, img, pageHeading, pagePara, form, history, setUsers, userData, defaultState, setDefaultState, }) => {
    ...
    const verifyOTP = async (values) => {
        ...
        try {
            ...
            console.log(data);
            setIsLoading(false);
            history.push("/supermarket/resetpassword");
                        ...
                        <Column1>
                            ...
                            >
                                <LoginBox>
                                    ...
                                    >We have sent you 4 digit verification code on your registered mobile number {(updateProfileValues.country_code || countryCode)} {(updateProfileValues.mobile_number || mobileNumers)}   </LoginPara>
                                </LoginBox>
                                <InputBox>
                                    <Formik
                                        enableReinitialize
