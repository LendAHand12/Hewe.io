...
const WithdrawHewe = ({ history, setUsers, userData }) => {
          ...
          <DashboardWrapper>
            <DashboardHeading style={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                ...
                <DashHeading style={{ color: "#02001c", flex: "1", padding: "8px" }}>Withdraw HEWE</DashHeading>
              </MenuAndBack>
            </DashboardHeading>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(WithdrawHewe));
