...
import "./style.scss";
import { Insta_icon, Telegram_icon, Twitter_icon } from "../svg";
  ...
  return (
    <>
      <section className="human">
        ...
        <div className="heading-p-cont">
          <p className="text-center">
            The development team converges their talent, creativity, and
            expertise required to monitor and innovate elements such as the
            dynamism, and broad activity in the market; contributing to the
            vision of HEWE.
          </p>
        </div>
        <div className="teams">
          <div className="row membercontainer align-items-center justify-content-center">
            {images.map((item, index) => (
              <div className="memberuppercont">
                <div className="membermidcont">
                  <div key={index} className="membercont h-100">
